...
const proposedChanges = [
  {
    client: "Saddle Fit 4 Life",
    from: "Kayla Puhov",
    to: "Dawn Thompson",
    role: "lead",
    hours: 4.4,
    reason: "Reduce Kayla's overload; Dawn has capacity and low complexity fit",
  },
  {
    client: "PSBX (Tova & Baron Manett)",
    from: "Kayla Puhov",
    to: "Shannon Shier",
    role: "lead",
    hours: 5.3,
